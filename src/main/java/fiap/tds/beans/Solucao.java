...
public class Solucao {
    ...
    private int solucao_final_solucao;

    public Solucao() {}

    public Solucao(String contato_mecanico_solucao, int idSolucao, String localizacao_oficina_solucao, int solucao_final_solucao) {
    ...
    public Solucao(int idSolucao, String contatoMecanico, String localizacaoOficina, int valorTotal) {
    }
    ...
    public int getSolucao_final_solucao() {
        return solucao_final_solucao;
    }

    public void setSolucao_final_solucao(int solucao_final_solucao) {
        this.solucao_final_solucao = solucao_final_solucao;
    }
}
